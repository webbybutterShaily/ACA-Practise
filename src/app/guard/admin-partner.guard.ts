...
/**
 * This class maintains the guard structure for partner administrative privileges
 */
@Injectable({ providedIn: 'root' })
export class AdminPartnerGuard implements CanActivate {
  ...
  public canActivate(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Promise<boolean> {
    ...
    if (!environment.guard.adminPartner.enabled) return Promise.resolve<boolean>(true);

    /**
     * TODO - Create an determinant to figure out if the user is a partner administrator
     */
