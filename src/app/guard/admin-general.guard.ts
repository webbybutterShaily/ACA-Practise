...
/**
 * This class maintains the guard structure for general administrative privileges
 */
@Injectable({ providedIn: 'root' })
export class AdminGeneralGuard implements CanActivate {
  ...
  public canActivate(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Promise<boolean> {
    ...
    if (!environment.guard.adminGeneral.enabled) return Promise.resolve<boolean>(true);

    /**
     * TODO - Create an determinant to figure out if the user is a general administrator
     */
